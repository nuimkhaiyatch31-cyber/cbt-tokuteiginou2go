...
explanation:
"Arti Soal:\nPekerjaan apa yang dilakukan oleh pekerja 鉄骨とび?\n\nJawaban:\nA. 鉄骨部材(てっこつぶざい)を使(つか)って高層(こうそう)ビルやマンションの骨組(ほねぐみ)をくみ上(あ)げていく作業(さぎょう)です\n\nArtinya:\nPekerjaan merakit rangka gedung tinggi atau apartemen menggunakan material baja.\n\nPembahasan:\n鉄骨とび adalah pekerjaan khusus merakit rangka baja bangunan tinggi seperti gedung dan apartemen.\n\nPilihan lain salah karena:\n\nB = lebih ke pekerjaan struktur sipil seperti jembatan ❌\nC = pekerjaan pemasangan mesin berat ❌\nD = pekerjaan pemasangan scaffolding ❌"
...
explanation:
"Arti Soal:\nPekerjaan apa yang memasang toilet dan wastafel?\n\nJawaban:\nA. 衛生器具設備工事(えいせいきぐせつびこうじ)\n\nArtinya:\nPekerjaan instalasi perlengkapan sanitasi.\n\nPembahasan:\n衛生器具設備工事 adalah pekerjaan pemasangan toilet, wastafel, dan perlengkapan sanitasi lainnya.\n\nPilihan lain salah karena:\n\nB = instalasi air panas ❌\nC = sistem pembuangan dan ventilasi ❌\nD = instalasi suplai air ❌"
...
explanation:
"Arti Soal:\nDalam dasar KYT terdapat 4 ronde. Pilih yang bukan termasuk salah satunya.\n\nJawaban:\nD. 危険予知活動(きけんよちかつどう)を行(おこな)う\n\nArtinya:\n“Melakukan kegiatan prediksi bahaya.”\n\nPembahasan:\nPilihan D bukan bagian dari 4 ronde dasar KYT.\n\n4 ronde KYT adalah:\n\n1. Mencari bahaya yang tersembunyi\n2. Menentukan titik bahaya utama\n3. Menentukan tindakan pencegahan\n4. Konfirmasi dengan tunjuk dan sebut\n\nPilihan A, B, dan C termasuk bagian KYT ✅"
...
explanation:
"Arti Soal:\nApa yang harus dipakai agar tidak mengalami gangguan paru-paru akibat menghirup zat berbahaya dalam jangka panjang?\n\nJawaban:\nD. 保護(ほご)マスク\n\nArtinya:\nMasker pelindung.\n\nPembahasan:\nDebu atau zat berbahaya yang terhirup terus-menerus dapat merusak paru-paru, sehingga wajib memakai masker pelindung.\n\nPilihan lain salah karena:\n\nA = hanya melindungi mata ❌\nB = hanya melindungi tangan ❌\nC = melindungi kepala dan wajah ❌"
...
explanation:
"Arti Soal:\nApa yang dimaksud dengan 手戻り?\n\nJawaban:\nA. ある作業をしないで先に進んでしまったため、その作業まで戻ってやりなおすことです\n\nArtinya:\nKarena ada pekerjaan yang terlewat lalu harus kembali ke tahap sebelumnya untuk mengerjakannya ulang.\n\nPembahasan:\n手戻り berarti mengulang pekerjaan karena ada proses yang salah atau terlewat.\n\nPilihan lain salah karena:\n\nB = kesalahan prosedur ❌\nC = kondisi pekerjaan terhenti ❌\nD = pekerjaan yang tidak berguna ❌"
...
explanation:
"Arti Soal:\nKegiatan keselamatan dan kesehatan kerja dibagi menjadi dua yaitu “manajemen keselamatan” dan apa?\n\nJawaban:\nC. 衛生管理(えいせいかんり)\n\nArtinya:\nManajemen kesehatan dan kebersihan kerja.\n\nPembahasan:\n安全衛生活動 dibagi menjadi:\n・安全管理 = manajemen keselamatan\n・衛生管理 = manajemen kesehatan/kebersihan kerja\n\nPilihan lain salah karena:\n\nA = hanya fokus kesehatan ❌\nB = manajemen pekerja ❌\nD = manajemen lapangan ❌"
...
explanation:
"Arti Soal:\nJika seseorang mengatakan 「ご苦労さま」, jawaban yang tepat apa?\n\nJawaban:\nC. ありがとうございます\n\nArtinya:\nTerima kasih.\n\nPembahasan:\nBalasan sopan dan umum digunakan saat menerima ucapan 「ご苦労さま」 adalah 「ありがとうございます」.\n\nPilihan lain salah karena:\n\nA = ungkapan menolak pujian ❌\nB = terlalu santai ❌\nD = digunakan setelah makan ❌"
