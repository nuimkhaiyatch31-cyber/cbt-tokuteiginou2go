...
{
question:
"PDCAサイクルのDとは<ruby>何<rt>なに</rt></ruby>をしますか。",

options:[

"A. <ruby>目標設定<rt>もくひょうせってい</rt></ruby>を<ruby>実行<rt>じっこう</rt></ruby>する",

"B. <ruby>計画<rt>けいかく</rt></ruby>を<ruby>実行<rt>じっこう</rt></ruby>する",

"C. <ruby>評価結果<rt>ひょうかけっか</rt></ruby>から<ruby>改善対策<rt>かいぜんたいさく</rt></ruby>を<ruby>実行<rt>じっこう</rt></ruby>する",

"D. <ruby>結果<rt>けっか</rt></ruby>の<ruby>評価<rt>ひょうか</rt></ruby>と<ruby>分析<rt>ぶんせき</rt></ruby>を<ruby>実行<rt>じっこう</rt></ruby>する"
...
explanation:
"Arti Soal:\nApa arti huruf D dalam siklus PDCA?\n\nB. 計画(けいかく)を実行(じっこう)する\n\nArtinya:\nMelaksanakan rencana.\n\nPembahasan:\nPDCA terdiri dari:\n\nP = Plan (Perencanaan)\nD = Do (Pelaksanaan)\nC = Check (Pemeriksaan/Evaluasi)\nA = Act (Perbaikan)\n\nPilihan lain salah karena:\n\nA = lebih dekat ke tahap Plan ❌\nC = tahap Act ❌\nD = tahap Check ❌"

},

{
question:
"<ruby>顧客<rt>こきゃく</rt></ruby>の<ruby>要望<rt>ようぼう</rt></ruby>に<ruby>合<rt>あ</rt></ruby>わせて、<ruby>一<rt>いち</rt></ruby>から<ruby>設計<rt>せっけい</rt></ruby>したものを<ruby>一<rt>ひと</rt></ruby>つだけ<ruby>作<rt>つく</rt></ruby>る<ruby>製造<rt>せいぞう</rt></ruby>のことは<ruby>何<rt>なん</rt></ruby>というか。",

options:[

"A. <ruby>受注一品生産<rt>じゅちゅういっぴんせいさん</rt></ruby>",

"B. <ruby>大量生産<rt>たいりょうせいさん</rt></ruby>",

"C. <ruby>現代生産<rt>げんだいせいさん</rt></ruby>",

"D. <ruby>自動化生産<rt>じどうかせいさん</rt></ruby>"
...
explanation:
"Arti Soal:\nApa sebutan untuk produksi yang dibuat satu per satu sesuai permintaan pelanggan?\n\nA. 受注一品生産(じゅちゅういっぴんせいさん)\n\nArtinya:\nProduksi berdasarkan pesanan khusus satuan.\n\nPembahasan:\n受注一品生産 adalah sistem produksi yang dibuat sesuai permintaan pelanggan dan biasanya hanya dibuat satu atau sedikit.\n\nPilihan lain salah karena:\n\nB = produksi massal ❌\nC = bukan istilah umum produksi ❌\nD = produksi otomatis, bukan berdasarkan pesanan khusus ❌"

},
  
{
question:
"<ruby>内外装仕上<rt>ないがいそうしあげ</rt></ruby><ruby>工事<rt>こうじ</rt></ruby>に<ruby>含<rt>ふく</rt></ruby>まないものはどれか。",

options:[

"A. ガス<ruby>工事<rt>こうじ</rt></ruby>",

"B. <ruby>左官工事<rt>さかんこうじ</rt></ruby>",

"C. <ruby>建具工事<rt>たてぐこうじ</rt></ruby>",

"D. <ruby>板金工事<rt>ばんきんこうじ</rt></ruby>"
...
explanation:
"Arti Soal:\nManakah yang tidak termasuk pekerjaan finishing interior dan eksterior?\n\nA. ガス工事(こうじ)\n\nArtinya:\nPekerjaan gas.\n\nPembahasan:\nPekerjaan finishing bangunan mencakup pekerjaan seperti plester (左官), pemasangan pintu/jendela (建具), dan pelat/logam (板金).\nSedangkan pekerjaan gas termasuk instalasi utilitas, bukan finishing.\n\nPilihan lain salah karena:\n\nB = termasuk pekerjaan finishing ❌\nC = termasuk pekerjaan finishing ❌\nD = termasuk pekerjaan finishing ❌"
...
explanation:
"Arti Soal:\nPilih yang bukan termasuk power harassment.\n\nD. 適正(てきせい)な仕事(しごと)の指示(しじ)\n\nArtinya:\nMemberikan instruksi pekerjaan yang sesuai.\n\nPembahasan:\nInstruksi kerja yang wajar dan sesuai tugas bukan termasuk harassment.\n\nPilihan lain salah karena:\n\nA = termasuk kekerasan verbal ❌\nB = memaksa secara tidak wajar ❌\nC = mengabaikan termasuk harassment ❌"
...
explanation:
"Arti Soal:\nApa sebutan untuk kesalahan memahami instruksi atau salah membaca gambar kerja yang menyebabkan masalah kualitas?\n\nD. 認知(にんち)ミス\n\nArtinya:\nKesalahan pengenalan/pemahaman.\n\nPembahasan:\n認知ミス terjadi ketika seseorang salah memahami informasi, instruksi, atau gambar kerja.\n\nPilihan lain salah karena:\n\nA = hanya penurunan perhatian ❌\nB = kelelahan bukan nama kesalahan ❌\nC = kurang komunikasi berbeda arti ❌"

},

{
question:
"<ruby>航空法<rt>こうくうほう</rt></ruby>に<ruby>関<rt>かん</rt></ruby>する、<ruby>重量<rt>じゅうりょう</rt></ruby>が100g<ruby>以上<rt>いじょう</rt></ruby>のドローンは<ruby>何<rt>なん</rt></ruby>の<ruby>登録<rt>とうろく</rt></ruby>が<ruby>義務化<rt>ぎむか</rt></ruby>されていますか。",

options:[

"A. <ruby>自動航空装置<rt>じどうこうくうそうち</rt></ruby>",

"B. <ruby>無人航空機<rt>むじんこうくうき</rt></ruby>",

"C. <ruby>無人航空船<rt>むじんこうくうせん</rt></ruby>",

"D. <ruby>無人飛行車<rt>むじんひこうしゃ</rt></ruby>"
...
explanation:
"Arti Soal:\nDrone dengan berat 100 gram atau lebih wajib didaftarkan sebagai apa menurut hukum penerbangan?\n\nB. 無人航空機(むじんこうくうき)\n\nArtinya:\nPesawat udara tanpa awak.\n\nPembahasan:\nDi Jepang, drone 100g atau lebih termasuk kategori 無人航空機 dan wajib registrasi.\n\nPilihan lain salah karena:\n\nA = bukan istilah resmi ❌\nC = bukan istilah hukum drone ❌\nD = bukan istilah resmi ❌"

},

{
question:
"「OJT」とは<ruby>何<rt>なん</rt></ruby>ですか。",

options:[

"A. <ruby>上司<rt>じょうし</rt></ruby>や<ruby>先輩<rt>せんぱい</rt></ruby>に<ruby>知識<rt>ちしき</rt></ruby>や<ruby>技術<rt>ぎじゅつ</rt></ruby>などを<ruby>身<rt>み</rt></ruby>につけさせること",

"B. <ruby>作業員<rt>さぎょういん</rt></ruby>のモチベーションに<ruby>力<rt>ちから</rt></ruby>を<ruby>入<rt>い</rt></ruby>れること",

"C. <ruby>職場<rt>しょくば</rt></ruby>の<ruby>上司<rt>じょうし</rt></ruby>や<ruby>先輩<rt>せんぱい</rt></ruby>が<ruby>部下<rt>ぶか</rt></ruby>や<ruby>後輩<rt>こうはい</rt></ruby>に<ruby>対<rt>たい</rt></ruby>して、<ruby>知識<rt>ちしき</rt></ruby>や<ruby>技術<rt>ぎじゅつ</rt></ruby>などを<ruby>身<rt>み</rt></ruby>につけさせる<ruby>教育<rt>きょういく</rt></ruby>すること",

"D. <ruby>職長<rt>しょくちょう</rt></ruby>は<ruby>作業員<rt>さぎょういん</rt></ruby>に<ruby>適切<rt>てきせつ</rt></ruby>な<ruby>指示<rt>しじ</rt></ruby>を<ruby>出<rt>だ</rt></ruby>すこと"
...
explanation:
"Arti Soal:\nApa itu OJT?\n\nC. 職場(しょくば)の上司(じょうし)や先輩(せんぱい)が部下(ぶか)や後輩(こうはい)に対(たい)して、知識(ちしき)や技術(ぎじゅつ)などを身(み)につけさせる教育(きょういく)すること\n\nArtinya:\nPendidikan/pelatihan langsung di tempat kerja oleh atasan atau senior.\n\nPembahasan:\nOJT = On the Job Training.\n\nPilihan lain salah karena:\n\nA = arah subjek terbalik ❌\nB = bukan definisi OJT ❌\nD = hanya tugas pemimpin kerja ❌"

},

{
question:
"<ruby>地震<rt>じしん</rt></ruby>のエネルギーを<ruby>建物<rt>たてもの</rt></ruby>に<ruby>伝<rt>つた</rt></ruby>えにくくするために、<ruby>基礎部分<rt>きそぶぶん</rt></ruby>に<ruby>免振装置<rt>めんしんそうち</rt></ruby>を<ruby>取<rt>と</rt></ruby>り<ruby>付<rt>つ</rt></ruby>ける<ruby>工事<rt>こうじ</rt></ruby>はどれですか。",

options:[

"A. <ruby>耐震工事<rt>たいしんこうじ</rt></ruby>",

"B. <ruby>制振工事<rt>せいしんこうじ</rt></ruby>",

"C. <ruby>免振工事<rt>めんしんこうじ</rt></ruby>",

"D. <ruby>解体工事<rt>かいたいこうじ</rt></ruby>"
...
explanation:
"Arti Soal:\nPekerjaan apa yang memasang alat isolasi gempa pada pondasi agar energi gempa sulit diteruskan ke bangunan?\n\nC. 免振工事(めんしんこうじ)\n\nArtinya:\nPekerjaan isolasi gempa.\n\nPembahasan:\n免振工事 menggunakan alat khusus untuk mengurangi getaran gempa yang masuk ke bangunan.\n\nPilihan lain salah karena:\n\nA = fokus memperkuat bangunan ❌\nB = fokus meredam getaran ❌\nD = pekerjaan pembongkaran ❌"

},

{
question:
"<ruby>効率的<rt>こうりつてき</rt></ruby>に<ruby>作業<rt>さぎょう</rt></ruby>を<ruby>進<rt>すす</rt></ruby>めたいという<ruby>気持<rt>きも</rt></ruby>ちから、<ruby>本来<rt>ほんらい</rt></ruby>やるべき<ruby>行動<rt>こうどう</rt></ruby>を<ruby>省略<rt>しょうりゃく</rt></ruby>してしまうことによって<ruby>起<rt>お</rt></ruby>こるヒューマンエラーは、<ruby>何<rt>なに</rt></ruby>か。",

options:[

"A. <ruby>判断<rt>はんだん</rt></ruby>ミス",

"B. <ruby>操作<rt>そうさ</rt></ruby>ミス",

"C. <ruby>近道<rt>ちかみち</rt></ruby><ruby>行動<rt>こうどう</rt></ruby>",

"D. <ruby>不注意<rt>ふちゅうい</rt></ruby>"
...
explanation:
"Arti Soal:\nHuman error apa yang terjadi karena ingin bekerja cepat sehingga mengabaikan prosedur?\n\nC. 近道(ちかみち)行動(こうどう)\n\nArtinya:\nTindakan mengambil jalan pintas.\n\nPembahasan:\nMengabaikan prosedur demi cepat selesai termasuk shortcut behavior.\n\nPilihan lain salah karena:\n\nA = kesalahan penilaian ❌\nB = kesalahan pengoperasian ❌\nD = kurang hati-hati ❌"

},

{
question:
"ヒューマンエラーに<ruby>含<rt>ふく</rt></ruby>まないものを<ruby>選<rt>えら</rt></ruby>べ。",

options:[

"A. <ruby>不注意<rt>ふちゅうい</rt></ruby>",

"B. <ruby>連絡不足<rt>れんらくぶそく</rt></ruby>",

"C. <ruby>疲労<rt>ひろう</rt></ruby>",
...
explanation:
"Arti Soal:\nPilih yang bukan termasuk human error.\n\nC. 疲労(ひろう)\n\nArtinya:\nKelelahan.\n\nPembahasan:\n疲労 adalah penyebab human error, bukan jenis human error itu sendiri.\n\nPilihan lain salah karena:\n\nA = termasuk human error ❌\nB = termasuk human error ❌\nD = berkaitan dengan kesalahan kognitif ❌"
